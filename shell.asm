...
;------------------------------------------------------SHELL FUNCTIONS----------------------------------------------------------------------
	...
	CHECK_SECTOR:
		...
		.END:
			...
			MOV WORD [FREE_SECTORS] , DX
			INC CL
			MOV BYTE [START_FS] , CL
			MOV BYTE [SECTOR_START] , CL
			MOV BX , 0X2000
			MOV ES , BX
			RET
...
;--------------------------------------------------------DATA----------------------------------------------------------------------------------					
	...
	PROMPT 			:	db ">>" , 0
	CMD_ERR			: 	DB " -------- NO COMMAND FOUND --------",10,13,10,13,0
	CMD_BUFFER	times 64 DB 0
	CMD_NAME		:	DB "HELP",4,0,0,0,0,"EDIT",4,0,0,0,0,"DIR",3,0,0,0,0,0,"VERSION",7,0,"AUTHOR",6,0,0,"CLEAR",5,0,0,0,"OPEN",4,0,0,0,0,"SHUTDOWN",8,13
	WRONG			:	DB " YOU HAVE DONE SOMETHING WRONG",10,13,0
	HELP_MSG		:	DB 10,13,"  HELP v1.0",10,13,"  Description --> Prints all the commands available",10,13,"---------------------------------------------------------",10,13,10,13,"  HELP      --    Prints all available command",10,13,"  DIR       --    Prints the information of Directory table",10,13,"  CLEAR     --    Clears the Screen",10,13,"  EDIT      --    Opens Editor to create Text file",10,13,"  OPEN      --    Opens a user file and prints the content",10,13,"  VERSION   --    Prints the Current Version of the OS",10,13,"  AUTHOR    --    Prints the information about the Author",10,13,"  SHUTDOWN  --    Shuts your Computer down",10,13,10,13,0
	...
	OPEN_FILE_PROMPT:   DB 10,13,"   CONTINUE TO EDIT(ENTER)                   CANCEL(ESC)  ",0
...
;	APM_NOTFOUND	:	DB 10,13,"APM NOT FOUND",0
	...
	SHUTTING_DOWN	:	DB 10,13,10,13,"   THANK YOU FOR USING OS : MAJOR  ",10,13,10,13,"   OPERATING SYSTEM : MAJOR IS SHUTTING DOWN .",0
	SHUTTING_DOWN_DOT	:	DB ".",0
	GOODBYE			:	DB 10 , 13 ,10,13 ,"                               GOOD - BYE  " , 0
	EMICON_I		:	DB ";",0
	EMICON_II		:	DB "-",0
	EMICON_III		:	DB "(",0
